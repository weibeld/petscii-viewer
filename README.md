...
An interactive application for visualising the [PETSCII character set](https://en.wikipedia.org/wiki/PETSCII) with a focus on the associated Commodore C64 key combinations to select the characters.
...
| <https://sta.c64.org/cbmdocs.html> | Miscellaneous collection of Commodore C64 notes and materials, for example, see [Commodore 64 PETSCII codes](https://sta.c64.org/cbm64pet.html) and [Commodore 64 PETSCII codes (with key combinations)](https://sta.c64.org/cbm64petkey.html) |
